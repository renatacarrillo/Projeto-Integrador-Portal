            ...
            <div class="col-12 col-md-12 col-lg-12">
                <section class="header-famosas">
                    <div class="jumbotron jumbotron-fluid">
                        <h1 class="display-2 text-white font-weight-bold text-center">TOP 10</h1>
                        <h2 class="text-white text-center">♫ Músicas clássicas mais famosas</h2>
                    </div>
                </section>
            </div>
                    ...
                    <table class="align-content-center tableclassica table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="fprimeiracolocada"><a href="https://www.youtube.com/watch?v=v2jir8opKlc" target="_blank" class="linklancamentos">Sonata Ao Luar</a></td>
