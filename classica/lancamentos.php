<?php
    $classica_pt = array("TOP 10","♫ Músicas clássicas mais famosas","Clique na composição e aprecie!","Artistas","Composições","Período","Sonata ao Luar","Classicismo","Impressionismo","Romantismo","Classicismo","Romantismo","Século XX e XXI","Classicismo","Romantismo","Romantismo","Barroco");

    $classica_en = array("TOP 10","♫ Classical musics most famous","Click in the composition and listen!","Artists","Compositions","Period","Moonlight Sonata","Classicism","Impressionism","Romanticism","Classicism","Romanticism","20th and 21st Century","Classicism","Romanticism","Romanticism","Baroque",);

    $classica_es = array("TOP 10","♫ Músicas clásicas más famosas","Haga clic en la composición y disfrute!","Artistas","Composiciones","Período","Sonata Al Chiaro Di Luna","Classicismo","Impresionismo","Romanticismo","Classicismo","Romanticismo","Siglo XX y XXI","Classicismo","Romanticismo","Romanticismo","Barroco");
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-4 mb-4">
                <article>
                    <h5 class="tlancamentos"><?php echo $classica[$ID][2]?></h5>
                    <table class="align-content-center tableclassica table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="fprimeiracolocada"><a href="https://www.youtube.com/watch?v=v2jir8opKlc" target="_blank" class="linklancamentos"><?php echo $classica[$ID][6]?></a></td>
                                <td class="fprimeiracolocada"><?php echo $classica[$ID][7]?></td>
                            </tr>
                            <tr>
                                <th>2º</th>
